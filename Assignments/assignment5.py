...
def spinningTransform():
    ...
    glTranslate(7, 7, 7)                                                    # translate to the center of the cube
    glRotatef(1, 0, 1, 0)                                                   # rotate the cube around the y-axis by 1 degree
    glTranslate(-7, -7, -7)                                                 # translate back to the original position
    return
...
def scaleByHalf():
    #TODO: Write your code below and call the function in main()
    glTranslate(7, 7, 7)                                                    #  translate to the center of the cube
    glScalef(0.5, 0.5, 0.5)                                                  # scale the cube by half
    glTranslate(-7, -7, -7)                                                 # translate back to the original position
...
def main():
    ...
    scaleByHalf() # function to scale the object
    ...
    while True:
        ...
        spinningTransform() # function to rotate the object
